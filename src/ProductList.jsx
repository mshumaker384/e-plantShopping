...
function ProductList() {
    ...
    const [addedToCart, sedAddedToCart] = useState({})
        ...
        <div>
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((catagory, index) => (
                        <div key="index">
                            <h1><div>{catagory.category}<div></div></div></h1>
                            <div className="product-list">
                                {catagory.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        <img alt={plant.image} className="product-image" src={plant.image}></img>
